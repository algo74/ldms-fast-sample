...
static int sample(struct ldmsd_sampler *self)
{
  ...
  LIST_FOREACH(sub_ctxt_p, &fulldump_sub_ctxt_list, link) {
...
static void term(struct ldmsd_plugin *self)
{
  ...
  struct fulldump_sub_ctxt *sub_ctxt_p = LIST_FIRST(&fulldump_sub_ctxt_list);
  while (sub_ctxt_p) {
  ...
  LIST_INIT(&fulldump_sub_ctxt_list);
}
